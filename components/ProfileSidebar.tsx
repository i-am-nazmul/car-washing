...
export default function ProfileSidebar({
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      />
      <aside className="absolute right-0 top-0 h-full w-full max-w-sm border-l border-amber-200/20 bg-[#050b28] p-6 text-amber-100 shadow-[0_0_30px_rgba(253,230,138,0.15)]">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold text-amber-200">Profile</h2>
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-amber-200/30 px-3 py-1 text-sm font-semibold text-amber-100 hover:bg-amber-200/10"
          >
            Close
          </button>
        </div>
        ...
        {!isEditingPhone ? (
          <button
            ...
            className="mt-4 w-full rounded-lg bg-linear-to-r from-amber-500 to-orange-500 px-4 py-2 text-white font-semibold cursor-pointer hover:from-amber-600 hover:to-orange-600 transition"
          >
            Edit Phone
          </button>
        ) : (
          <div className="mt-4 rounded-2xl border border-amber-200/20 bg-[#060b26] p-4">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                disabled={isSaving}
                className="flex-1 rounded-lg bg-amber-200/20 px-3 py-2 text-amber-100 font-semibold hover:bg-amber-200/30 transition disabled:opacity-60 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="flex-1 rounded-lg border border-amber-200/30 px-3 py-2 text-amber-100 font-semibold hover:bg-amber-200/10 transition"
              >
                Cancel
              </button>
            </div>
        ...
        <div className="mt-6 flex gap-2">
          <button
            ...
            className="flex-1 rounded-lg border border-amber-200/30 px-4 py-2 text-amber-100 font-semibold hover:bg-amber-200/10 transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <button
            type="button"
            onClick={handleHome}
            className="flex-1 rounded-lg bg-amber-200/20 px-4 py-2 text-amber-100 font-semibold hover:bg-amber-200/30 transition"
          >
            Home
          </button>
        </div>
