...
function AboutSectionComponent() {
  return (
    <section id="about" className="mt-10 w-full max-w-6xl px-4 sm:px-6">
      <h2 className={HOME_SECTION_TITLE}>ABOUT US</h2>
      <div className="mt-2 flex w-full items-center justify-center">
        <p className={`w-full ${HOME_SECTION_SUBTITLE}`}>The New Standard of Vehicle Care.</p>
      </div>
      ...
      <div className="mx-auto mt-5 rounded-3xl border border-violet-300 p-3 text-left shadow-[0_0_18px_rgba(139,92,246,0.35)] sm:p-6 lg:p-8">
        <div className={`flex flex-col space-y-3 ${HOME_SECTION_BODY} sm:space-y-4`}>
          <p>
